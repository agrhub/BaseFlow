...
exports.getReadmeAnalysisPrompt = getReadmeAnalysisPrompt;
exports.getArchitectureDiagramsPrompt = getArchitectureDiagramsPrompt;
exports.getClassAnalysisPrompt = getClassAnalysisPrompt;
exports.getDocAnalysisPrompt = getDocAnalysisPrompt;
exports.getGenerateSkillPrompt = getGenerateSkillPrompt;
exports.getDocChatPrompt = getDocChatPrompt;
 ...
 */
function getReadmeAnalysisPrompt(readmeContent) {
 ...
 */
function getArchitectureDiagramsPrompt(conn, classSummaries) {
 ...
 */
function getClassAnalysisPrompt(params) {
 ...
 */
function getDocAnalysisPrompt(docPath, content) {
 ...
 */
function getGenerateSkillPrompt(content) {
 ...
 */
function getDocChatPrompt(docPath, content, query) {
 ...
 */
function getAgentInstruction(params) {
